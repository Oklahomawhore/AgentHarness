...
macOS/Linux 需要 curl、tar 和 sha256sum 或 shasum；Windows x64 需要 PowerShell 和 tar。如果 npm 暂时不可用，也可以通过 `npx --yes <URL>` 运行 [GitHub Release 启动包](https://github.com/Oklahomawhore/AgentHarness/releases/latest/download/agentharness-npm.tgz)。
