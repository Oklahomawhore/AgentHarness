...
如果 npm 暂时不可用，也可使用 [GitHub Release 中带版本的安装包](https://github.com/Oklahomawhore/AgentHarness/releases/download/v0.2.3/agentharness-npm.tgz)。macOS/Linux 需要 curl、tar 和 sha256sum 或 shasum；Windows x64 需要 PowerShell 和 tar。
