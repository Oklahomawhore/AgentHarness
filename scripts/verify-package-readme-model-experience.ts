...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/collaboration/development-mesh-websocket': { kind: 'none', reason: 'The authenticated peer transport does not register model input.' },
  'packages/collaboration/development-room': { kind: 'none', reason: 'Room membership is runtime state and does not enter a model request.' },
  'packages/collaboration/development-room-context-storage-domain': { kind: 'none', reason: 'The storage provider persists explicit Room context without assembling model input.' },
  'packages/collaboration/development-room-mesh': { kind: 'none', reason: 'The Room Mesh consumer only replicates membership state.' },
  'packages/collaboration/development-room-storage-domain': { kind: 'none', reason: 'The storage provider persists Room events without assembling model input.' },
  'packages/collaboration/development-task': { kind: 'none', reason: 'The Task service exposes Host data; its context consumer owns model admission.' },
  'packages/collaboration/development-task-mesh': { kind: 'none', reason: 'The Task Mesh consumer only replicates Task state.' },
  'packages/collaboration/development-task-storage-domain': { kind: 'none', reason: 'The storage provider persists Task events without assembling model input.' },
  'packages/host/mcp-client-setup': { kind: 'none', reason: 'Host MCP client setup changes local client configuration and adds no model input.' },
  'packages/host/dev-workbench': { kind: 'none', reason: 'Human-operated development process control does not register model input.' },
