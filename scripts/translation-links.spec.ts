...
it('recognizes only the top-level language switcher after landing-page frontmatter', () => {
  const valid = '---\nlayout: false\ntitle: Home\n---\n\nEnglish | [中文](index.zh.md)\n\n<LandingPage />\n'
  const absent = '---\nlayout: false\ntitle: Home\n---\n\n<LandingPage />\n'
  expect(hasLanguageSwitcher(parseTranslationMarkdown(valid), valid, 'index.zh.md')).toBe(true)
  expect(hasLanguageSwitcher(parseTranslationMarkdown(absent), absent, 'index.zh.md')).toBe(false)
})
