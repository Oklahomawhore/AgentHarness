...
export const SERVICE_PAGE: Record<string, string> = {
  devWorkbench: 'development-workbench.md',
  developmentEvidence: 'development-room.md',
  developmentMesh: 'development-room.md',
  developmentRoomContexts: 'development-room.md',
  developmentRoomMesh: 'development-room.md',
  developmentRoomStorageReady: 'development-room.md',
  developmentRooms: 'development-room.md',
  developmentTaskAssignments: 'development-room.md',
  developmentTaskMesh: 'development-room.md',
  developmentTasks: 'development-room.md',
  mcp: 'mcp.md',
  mcpClientSetup: 'mcp.md',
  agentLoop: 'core.md',
...
export const EVENT_SCOPE_PAGE: Record<string, string> = {
  'development-evidence': 'development-room.md',
  'development-mesh': 'development-room.md',
  'development-room-context': 'development-room.md',
  'development-room': 'development-room.md',
  'development-task': 'development-room.md',
  mcp: 'mcp.md',
  'agent': 'core.md',
  'agent-loop': 'core.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  DevWorkbenchEntryId: 'development-workbench.md',
  DevWorkbenchEntrySnapshot: 'development-workbench.md',
  DevWorkbenchSnapshot: 'development-workbench.md',
  DevelopmentEvidenceProvider: 'development-room.md',
  DevelopmentEvidenceQueryRequest: 'development-room.md',
  DevelopmentEvidenceQuerySnapshot: 'development-room.md',
  DevelopmentMeshChannel: 'development-room.md',
  DevelopmentMeshSnapshot: 'development-room.md',
  DevelopmentNodeId: 'development-room.md',
  DevelopmentParticipantAnnounceRequest: 'development-room.md',
  DevelopmentParticipantHeartbeatRequest: 'development-room.md',
  DevelopmentParticipantWithdrawRequest: 'development-room.md',
  DevelopmentRoomContextShareRequest: 'development-room.md',
  DevelopmentRoomContextSnapshot: 'development-room.md',
  DevelopmentRoomCreateRequest: 'development-room.md',
  DevelopmentRoomDirectorySnapshot: 'development-room.md',
  DevelopmentRoomEnsureRequest: 'development-room.md',
  DevelopmentRoomJoinRequest: 'development-room.md',
  DevelopmentRoomLeaveRequest: 'development-room.md',
  DevelopmentTaskAcknowledgeRequest: 'development-room.md',
  DevelopmentTaskCheckoutRequest: 'development-room.md',
  DevelopmentTaskCheckoutResult: 'development-room.md',
  DevelopmentTaskClearRequest: 'development-room.md',
  DevelopmentTaskContextView: 'development-room.md',
  DevelopmentTaskCreateRequest: 'development-room.md',
  DevelopmentTaskCreateResult: 'development-room.md',
  DevelopmentTaskGetRequest: 'development-room.md',
  DevelopmentTaskId: 'development-room.md',
  DevelopmentTaskLineageRequest: 'development-room.md',
  DevelopmentTaskLineageSnapshot: 'development-room.md',
  DevelopmentTaskListRequest: 'development-room.md',
  DevelopmentTaskMeshCommand: 'development-room.md',
  DevelopmentTaskPublishContextRequest: 'development-room.md',
  McpCallRequest: 'mcp.md',
  McpCallResult: 'mcp.md',
  McpClientSetupRequest: 'mcp.md',
  McpClientSetupResult: 'mcp.md',
  McpClientSetupSnapshot: 'mcp.md',
  McpServerProvider: 'mcp.md',
  DevelopmentEvidenceProviderRegistration: 'development-room.md',
  DevelopmentMeshPeerSnapshot: 'development-room.md',
  DevelopmentParticipantSnapshot: 'development-room.md',
  DevelopmentRoomContextEntry: 'development-room.md',
  DevelopmentRoomContextEventOrigin: 'development-room.md',
  DevelopmentRoomEventOrigin: 'development-room.md',
  DevelopmentRoomLogEntry: 'development-room.md',
  DevelopmentRoomSnapshot: 'development-room.md',
  DevelopmentTaskAssignment: 'development-room.md',
  DevelopmentTaskAssignmentLogEntry: 'development-room.md',
  DevelopmentTaskContextBlock: 'development-room.md',
  DevelopmentTaskEventOrigin: 'development-room.md',
  DevelopmentTaskLogEntry: 'development-room.md',
  DevelopmentTaskSnapshot: 'development-room.md',
  McpServerRegistration: 'mcp.md',
  Agent: 'core.md',
