...
try {
  ...
  await writeFile(resolve(output, 'package.json'), `${JSON.stringify({
    name: '@sandboxbreak/agentharness', version: release.version, type: 'module', license: 'MIT',
    author: 'Wangshu Zhu',
