...
interface BenchOptions {
  ...
  disabled?: boolean
  inert?: boolean
  blocked?: { readonly reason: string; readonly onActivate?: () => void }
...
describe('running and lock semantics', () => {
  ...
  it('opens model configuration when the blocked input is activated', () => {
    const onActivate = vi.fn()
    const { textarea, sink } = bench({ blocked: { reason: '请选择可用模型', onActivate } })
