...
| Page | Owns |
|---|---|
| [development-room.md](development-room.md) | Task DAG, Room membership, Mesh replication, and context injection |
| [development-workbench.md](development-workbench.md) | Local development tasks, process lifecycle, logs, and preview views |
| [mcp.md](mcp.md) | MCP client registration, bridge tools, and remote tool execution |
