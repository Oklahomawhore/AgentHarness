...
| 页面 | 负责内容 |
|---|---|
| [development-room.md](development-room.zh.md) | Task DAG、Room 成员、Mesh 复制与上下文注入 |
| [development-workbench.md](development-workbench.zh.md) | 本地开发任务、进程生命周期、日志与预览视图 |
| [mcp.md](mcp.zh.md) | MCP 客户端注册、桥接工具与远程工具执行 |
