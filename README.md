...
The shorter `npx --yes agentharness` command will work after the first npm publication. macOS/Linux need curl, tar, and sha256sum or shasum; Windows x64 needs PowerShell and tar.
