...
The [failover runbook](2026-07-26-ci-failover-runbook.md) remains the owner of repository trust and pool switching. The serial reference decision remains the owner of master scheduling. Neither decision is superseded beyond the compatibility jobs' runner selection; both remain active.
